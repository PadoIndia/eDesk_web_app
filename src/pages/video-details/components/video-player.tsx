...
export default function VideoPlayer({ id, poster, src, addTimeStamp }: Props) {
  ...
  useEffect(() => {
    ...
    // Initialize HLS.js for HLS support
    ...
    if (Hls.isSupported()) {
      ...
      video.src = src; // For native support of HLS in browsers like Safari
    }
