...
//   //       console.log("user Data", userDepartmentData);

//   //       setUserDepartments(userDepartmentData);

//   //       // Then fetch requests based on user department and admin status
//   //       let response;
...
//       // Fetch requests based on user roles
...
//         allRequests = response.data;
//       } else {
//         // User is neither HR nor Manager - get own requests
